	...
	class Program
	{
		static void Main(String[] args)
		{
			...
			for(int i = 0;i < args.Length; i++)
			{
				...
				else if(currentArg == "-r" || currentArg == "--reverse-role")
				{
					Filters.AddFilter(new NodePortIPLink(ipConfig.ip, ipConfig.ports[0]), new NetNode.Filter.ClientAsServer(true));
				}
			}
